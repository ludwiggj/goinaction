...
// Creating error interface variables is a common practice in Go.
// This allows the caller to identify specific returned error values
// from any function or method within the package.
